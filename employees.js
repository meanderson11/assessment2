...
// let fred = new Employee('Maria', 'Days')

// console.log(fred.getSchedule());
...
//CODE HERE
let empOne = new Employee({'name': 'Jess', 'shifts': 'weekday mornings, week afternoons'})
...
let manager = new Manager({"name": 'Winston', "shifts": 'weekday mornings, weekday afternoons', "employees": ['Cece', 'Schmidt']});
